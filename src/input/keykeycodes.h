...
typedef enum key_keycode {
    ...
    KEY_KEYCODE_NUMLOCKCLEAR = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_NUMLOCKCLEAR),
    ...
    KEY_KEYCODE_KP_EQUALSAS400 = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_EQUALSAS400),
    ...
    KEY_KEYCODE_THOUSANDSSEPARATOR = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_THOUSANDSSEPARATOR),
    KEY_KEYCODE_DECIMALSEPARATOR = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_DECIMALSEPARATOR),
    KEY_KEYCODE_CURRENCYUNIT = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_CURRENCYUNIT),
    KEY_KEYCODE_CURRENCYSUBUNIT = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_CURRENCYSUBUNIT),
    KEY_KEYCODE_KP_LEFTPAREN = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_LEFTPAREN),
    KEY_KEYCODE_KP_RIGHTPAREN = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_RIGHTPAREN),
    KEY_KEYCODE_KP_LEFTBRACE = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_LEFTBRACE),
    KEY_KEYCODE_KP_RIGHTBRACE = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_RIGHTBRACE),
    KEY_KEYCODE_KP_TAB = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_TAB),
    KEY_KEYCODE_KP_BACKSPACE = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_BACKSPACE),
    ...
    KEY_KEYCODE_KP_AMPERSAND = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_AMPERSAND),
    KEY_KEYCODE_KP_DBLAMPERSAND = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_DBLAMPERSAND),
    KEY_KEYCODE_KP_VERTICALBAR = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_VERTICALBAR),
    KEY_KEYCODE_KP_DBLVERTICALBAR = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_DBLVERTICALBAR),
    ...
    KEY_KEYCODE_KP_MEMRECALL = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_MEMRECALL),
    ...
    KEY_KEYCODE_KP_MEMSUBTRACT = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_MEMSUBTRACT),
    KEY_KEYCODE_KP_MEMMULTIPLY = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_MEMMULTIPLY),
    KEY_KEYCODE_KP_MEMDIVIDE = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_MEMDIVIDE),
    KEY_KEYCODE_KP_PLUSMINUS = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_PLUSMINUS),
    KEY_KEYCODE_KP_CLEAR = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_CLEAR),
    KEY_KEYCODE_KP_CLEARENTRY = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_CLEARENTRY),
    ...
    KEY_KEYCODE_KP_HEXADECIMAL = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KP_HEXADECIMAL),
    ...
    KEY_KEYCODE_AC_BOOKMARKS = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_AC_BOOKMARKS),

    KEY_KEYCODE_BRIGHTNESSDOWN = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_BRIGHTNESSDOWN),
    KEY_KEYCODE_BRIGHTNESSUP = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_BRIGHTNESSUP),
    KEY_KEYCODE_DISPLAYSWITCH = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_DISPLAYSWITCH),
    KEY_KEYCODE_KBDILLUMTOGGLE = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KBDILLUMTOGGLE),
    KEY_KEYCODE_KBDILLUMDOWN = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_KBDILLUMDOWN),
    ...
    KEY_KEYCODE_AUDIOFASTFORWARD = KEY_SCANCODE_TO_KEYCODE(KEY_SCANCODE_AUDIOFASTFORWARD)
} key_keycode;
