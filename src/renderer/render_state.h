...
#define RST_CULL_BITS       (UINT64_C(2) << 15)
...
#define RST_SEPARATE_STENCIL  (RST_BACK_STENCIL_OP_FAIL_BITS | RST_BACK_STENCIL_OP_ZFAIL_BITS |                  \
    RST_BACK_STENCIL_OP_PASS_BITS)
#define RST_STENCIL_OP_BITS   (RST_STENCIL_OP_FAIL_BITS | RST_STENCIL_OP_ZFAIL_BITS | RST_STENCIL_OP_PASS_BITS | \
    RST_SEPARATE_STENCIL)
...
#define RST_BASIC_3D (RST_CULL_FRONTSIDED | RST_DEPTHFUNC_LESS)
